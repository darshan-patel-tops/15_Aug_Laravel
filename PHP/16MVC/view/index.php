    ...
    <div class="container-fluid bg-light my-6 mt-0" id="home">
        <div class="container">
            <div class="row g-5 align-items-center">
                ...
                <div class="col-lg-6">
                    <img class="img-fluid" src="<?php echo $this->public_url; ?>img/profile.png" alt="">
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row g-5">
                ...
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="row g-3 mb-4">
                        <div class="col-sm-6">
                            <img class="img-fluid rounded" src="<?php echo $this->public_url; ?>img/about-1.jpg" alt="">
                        </div>
                        <div class="col-sm-6">
                            <img class="img-fluid rounded" src="<?php echo $this->public_url; ?>img/about-2.jpg" alt="">
                        </div>
                    </div>
